...
public class BubblesService extends Service {
    ...
    @SuppressLint({"InflateParams", "RtlHardcoded", "ObsoleteSdkInt"})
    @Override
    public void onCreate() {
        super.onCreate();
        //Inflate the floating view layout we created
        mFloatingView = LayoutInflater.from(this).inflate(R.layout.buble_chat, null);
        ...
        ImageView send = mFloatingView.findViewById(R.id.sendButton);
